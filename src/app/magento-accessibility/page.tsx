        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            <div className="bg-slate-700/50 rounded-lg p-4 border-l-4 border-red-500">
              ...
              <p className="text-slate-300 text-sm">Magento's faceted search and filter system often lacks keyboard support and ARIA labels, making it impossible for screen reader users to filter products</p>
            </div>
            <div className="bg-slate-700/50 rounded-lg p-4 border-l-4 border-red-500">
              <h3 className="font-semibold text-lg mb-1">Configurable Product Selectors</h3>
              <p className="text-slate-300 text-sm">Swatch selectors for size, color, and other attributes frequently missing proper labels and keyboard interactions</p>
            </div>
            <div className="bg-slate-700/50 rounded-lg p-4 border-l-4 border-amber-500">
              ...
              <p className="text-slate-300 text-sm">Cart updates happen silently without screen reader announcements, leaving users unaware of changes</p>
            </div>
            <div className="bg-slate-700/50 rounded-lg p-4 border-l-4 border-amber-500">
              <h3 className="font-semibold text-lg mb-1">Checkout Step Indicators</h3>
              <p className="text-slate-300 text-sm">Multi-step checkout progress is often not communicated to assistive technology users</p>
            </div>
            <div className="bg-slate-700/50 rounded-lg p-4 border-l-4 border-yellow-500">
              ...
              <p className="text-slate-300 text-sm">Fotorama and other gallery extensions lack alt text and keyboard navigation support</p>
            </div>
            <div className="bg-slate-700/50 rounded-lg p-4 border-l-4 border-yellow-500">
              <h3 className="font-semibold text-lg mb-1">Third-Party Extension Conflicts</h3>
              <p className="text-slate-300 text-sm">Popular extensions for reviews, wishlists, and comparisons often inject inaccessible components</p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
            {[
              ...
              <div key={version} className="bg-slate-700/30 rounded-lg p-3 text-center">
                <span className="text-slate-200 text-sm">{version}</span>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-slate-700/50 rounded-lg p-4">
              ...
              <p className="text-slate-300 text-sm">Layered navigation, sorting, pagination, product grid</p>
            </div>
            <div className="bg-slate-700/50 rounded-lg p-4">
              <h3 className="font-semibold text-orange-400 mb-2">Product Detail Pages</h3>
              <p className="text-slate-300 text-sm">Configurables, bundles, grouped products, galleries, reviews</p>
            </div>
            <div className="bg-slate-700/50 rounded-lg p-4">
              <h3 className="font-semibold text-orange-400 mb-2">Shopping Cart</h3>
              <p className="text-slate-300 text-sm">Quantity updates, coupons, shipping estimator, totals</p>
            </div>
            <div className="bg-slate-700/50 rounded-lg p-4">
              <h3 className="font-semibold text-orange-400 mb-2">Checkout Flow</h3>
              <p className="text-slate-300 text-sm">Shipping, billing, payment methods, order review</p>
            </div>
            <div className="bg-slate-700/50 rounded-lg p-4">
              <h3 className="font-semibold text-orange-400 mb-2">Customer Account</h3>
              <p className="text-slate-300 text-sm">Registration, login, dashboard, order history, addresses</p>
            </div>
            <div className="bg-slate-700/50 rounded-lg p-4">
              <h3 className="font-semibold text-orange-400 mb-2">Search Results</h3>
              <p className="text-slate-300 text-sm">Search suggestions, results filtering, no results handling</p>
            </div>
          </div>
        </section>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-300 text-sm">No extension installation needed - just paste your Magento store URL</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-300 text-sm">We crawl key pages including products, categories, cart, and checkout</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-slate-300 text-sm">Receive detailed fix instructions referencing Magento templates and XML layouts</p>
              </div>
            </div>
          </div>
        </section>
